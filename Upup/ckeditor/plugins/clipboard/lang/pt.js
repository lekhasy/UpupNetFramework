...
CKEDITOR.plugins.setLang( 'clipboard', 'pt', {
	copy: 'Copiar',
	copyError: 'A configuração de segurança do nabookydor não permite a execução automática de operações de copiar. Por favor use o teclado (Ctrl/Cmd+C).',
	cut: 'Cortar',
	cutError: 'A configuração de segurança do nabookydor não permite a execução automática de operações de cortar. Por favor use o teclado (Ctrl/Cmd+X).',
	paste: 'Colar',
